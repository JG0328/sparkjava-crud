...
<div class="container">
    ...
    <div class="row margin-top-20">
        <div class="col-md-12">
            <form action="/estudiantes/actualizar/${estudiante.idEstudiante}" method="POST">
                ...
                <div class="form-group col-md-5">
                    ...
                    <input name="nombre" type="text" placeholder="Nombre del estudiante" class="form-control"
                ...
                <div class="form-group col-md-5">
                    <div class="row">
                        ...
                        <div class="col-md-6 text-right">
                            <button name="enviar" type="submit" class="btn btn-success">Actualizar</button>
                        </div>
                    </div>
                </div>
            </form>
